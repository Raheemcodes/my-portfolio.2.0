...
export class SharedService {
  projects: Project[] = [
    ...
    {
      title: 'Lonad',
      desc: 'Landing page for an upcomping project on Monad Testnet',
      img: './../../assets/projects/lonad.png',
      areas: ['NextJS', 'SCSS', 'TypeScript'],
      background: '#f8a868',
      link: {
        github: 'https://github.com/Raheemcodes',
        website: 'https://www.lonad.club/',
      },
    },
    {
      title: 'Mafiaz',
    ...
    // },
    {
      ...
      desc: 'An implementation of a fullstack entertainment app design from frontend mentor',
      img: './../../assets/projects/entertainment.png',
      areas: ['NextJS', 'SCSS', 'TypeScript', 'FrontendMentor'],
      background: '#3A465E',
      link: {
        github: 'https://github.com/Raheemcodes/entertainment-web-app',
        website: 'https://entertainment-web-app-iota-sooty.vercel.app/',
      },
    },
    {
      ...
      areas: ['ReactJS', 'SCSS', 'TypeScript', 'FrontendMentor'],
      background: '#ffffff',
      link: {
